return {
  ...
  config = function()
    ...
    local root_path = '/home/luc/.local/share/nvim/servers/lua-language-server'
    local binary = '/home/luc/.local/share/nvim/servers/lua-language-server/bin/lua-language-server'
